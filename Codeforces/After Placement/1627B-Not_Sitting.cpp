...
class Codeforces
{
    ...
    public:
        ...
        ll solve()
        {
            ...
            for(ll i=0;i<n;i++){
                for(ll j=0;j<m;j++){
                    ll corner1=abs(i+1-1)+abs(j+1-1);
                    ll corner2=abs(i+1-n)+abs(j+1-m);
                    ll corner3=abs(i+1-n)+abs(j+1-1);
                    ll corner4=abs(i+1-1)+abs(j+1-m);
                    ll maxo=max({corner1,corner2,corner3,corner4});
                    v.pb(maxo);
                }
            }
            srt(v);
